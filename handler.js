        ...
        case 'remove':
          if (chat.welcome) {
            ...
            for (let user of participants) {
              let kai = await(await fetch('https://telegra.ph/file/49267a7a90c167cd706e1.jpg')).buffer()
              let poi = await(await fetch('https://telegra.ph/file/49267a7a90c167cd706e1.jpg')).buffer()
